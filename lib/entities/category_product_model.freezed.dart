...
/// @nodoc
@JsonSerializable()
class _$CategoryProductModelImpl implements _CategoryProductModel {
  ...
  @override
  String toString() {
    return 'CategoryProductModel(success: $success, message: $message, data: $data)';
  }
...
abstract class _CategoryProductModel implements CategoryProductModel {
  const factory _CategoryProductModel(
      ...
      @JsonKey(name: "data") final Data? data}) = _$CategoryProductModelImpl;
